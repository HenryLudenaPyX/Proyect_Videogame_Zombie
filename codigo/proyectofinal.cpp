...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        zombieDogTransform = glm::translate(zombieDogTransform, glm::vec3(-2.0f, 0.0f, -1.0f)); // Posición del zombie dog
        ...
        zombie1Transform = glm::translate(zombie1Transform, glm::vec3(4.0f, 0.0f, -5.0f)); // Posición del zombie 1
        ...
        zombie2Transform = glm::translate(zombie2Transform, glm::vec3(-4.0f, 0.0f, -6.0f)); // Posición del zombie 2
        ...
        zombie3Transform = glm::translate(zombie3Transform, glm::vec3(0.0f, 0.0f, -7.0f)); // Posición del zombie 3
